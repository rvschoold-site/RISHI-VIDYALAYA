  ...
  return (
    <div className={styles.container}>
      <div className="page-hero">
        ...
        <p>An IIT-NEET Foundation School in Dharmavaram</p>
      </div>
              ...
              <div style={{ backgroundColor: 'var(--bg-card)', padding: 'var(--spacing-2xl)', borderRadius: '20px', boxShadow: '0 4px 20px -5px rgba(0,0,0,0.05)' }}>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                  <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: '2px' }}><polyline points="20 6 9 17 4 12"></polyline></svg>
        ...
        <div className="grid3">
          <Reveal delay={0.1}>
            <div className="card" style={{ textAlign: 'center' }}>
              <svg className="icon-float" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ margin: '0 auto 1rem' }}><circle cx="12" cy="12" r="10"></circle><path d="M12 8l4 4-4 4M8 12h7"></path></svg>
              <h3>Integrity</h3>
          ...
          <Reveal delay={0.2}>
            <div className="card" style={{ textAlign: 'center' }}>
              <svg className="icon-float" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ margin: '0 auto 1rem', animationDelay: '0.4s' }}><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
              <h3>Excellence</h3>
          ...
          <Reveal delay={0.3}>
            <div className="card" style={{ textAlign: 'center' }}>
              <svg className="icon-float" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ margin: '0 auto 1rem', animationDelay: '0.8s' }}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
              <h3>Compassion</h3>
